...
<body class="theme-red">
  ...
  <div class="vg-page page-home" id="home" style="background-image: url(/img/bg_image_1.jpg)">
    ...
    <div class="navbar navbar-expand-lg navbar-dark sticky" data-offset="500">
      <div class="container">
        <a href="" class="navbar-brand">Ashish-Folio</a>
        ...
        <div class="collapse navbar-collapse" id="main-navbar">
          ...
          <ul class="nav ml-auto">
            <li class="nav-item">
              <button class="btn btn-fab btn-theme no-shadow">AY</button>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="caption-header text-center wow zoomInDown">
      ...
      <h1 class="fw-light mb-4">I'm <b class="fg-theme">Ashish</b> Yadav</h1>
      <div class="badge">Software & Web Designer</div>
    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          <h1 class="fw-light">Ashish Yadav</h1>
          <h5 class="fg-theme mb-3">Software & Web Designer</h5>
          ...
          <ul class="theme-list">
            <li><b>From:</b> Kanpur, UP</li>
            <li><b>Lives In:</b> Kanpur, UP</li>
            <li><b>Age:</b> 22</li>
      ...
      <div class="row py-3">
        <div class="col-md-6">
          <div class="px-lg-3">
            ...
            <div class="progress-wrapper wow fadeInUp">
              <span class="caption">Dot Net</span>
              <div class="progress">
          ...
          <ul class="timeline mt-4 pr-md-5">
            <li>
              ...
              <div class="details">
                ...
                <small class="fg-theme">Rama University</small>
            ...
            <li>
              ...
              <div class="details">
                <h5>Specialize of course</h5>
                <small class="fg-theme">Rama University </small>
                <p>Polytechnic Computer Science</p>
              </div>
            </li>
            <li>
              ...
              <div class="details">
                <h5>Specialize of course</h5>
                <small class="fg-theme">Allahabad Board</small>
                <p>Intermediate</p>
              </div>
            </li>
          </ul>
                ...
                <div class="col-md-6">
                  <div class="caption">
                    ...
                    <div class="testi-info">
                      ...
                      <div class="tagline">
                        <h5 class="mb-0">Akanksha Katiyar</h5>
                ...
                <div class="col-md-6">
                  <div class="caption">
                    ...
                    <div class="testi-info">
                      ...
                      <div class="tagline">
                        <h5 class="mb-0">Mukesh Yadav</h5>
                        <span class="text-muted">CEO Mukesh Foundation</span>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <!-- Footer -->
  <div class="vg-footer">
    <h1 class="text-center">Ashish Folio</h1>
    <div class="container">
      <div class="row">
        <div class="col-lg-4 py-3">
          <div class="footer-info">
            ...
            <hr class="divider">
            <p class="fs-large fg-white">517 IIT Gate Kalyanpur , kanpur 208016 UP</p>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-3 py-3">
          <div class="float-lg-right">
            ...
            <hr class="divider">
            <ul class="list-unstyled">
              <li>ashishyadav8052@gmail.com</li>
              <li>7054775473</li>
              <li>7054775473</li>
            </ul>
          </div>
      ...
      <div class="row justify-content-center mt-3">
        ...
        <div class="col-12">
          <p class="text-center mb-0 mt-4">Copyright @ Ashish &copy;2020. All right reserved | This template is made with <span class="ti-heart fg-theme-red"></span> by <a href="https://www.macodeid.com/">ASHISH YADAV</a></p>
        </div>
      </div>
    </div>
  </div> <!-- End footer -->
